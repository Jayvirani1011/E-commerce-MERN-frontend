            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                                            ...
                                            <li key={address.email} className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                                                <div className="flex min-w-0 gap-x-4">
                                                    ...
                                                    <div className="min-w-0 flex-auto">
                                                        ...
                                                        <p className="mt-1 truncate text-xs leading-5 text-gray-500">{address.state} {address.zip}</p>
                                                    </div>
                                                </div>
                                                <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                                    <p className="text-sm leading-6 text-gray-900">{address.phone}</p>
                                                    <p className="text-sm leading-6 text-gray-500">{address.email}</p>
                                                </div>
                                            </li>
                                        ))}
                                    </ul>
                    ...
                    <div className="lg:col-span-2">
                        <div className="mx-auto mt-10 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
